...
(* OASIS_START *)
(* DO NOT EDIT (digest: a9d05fd795cfd1422bf1f6917b0b5c8b) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Constants"; "Common"; "Request"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "cloudstack";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "cloudstack_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Cloudstack_lwt_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cloudstack";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "cloudstack";
                           InternalLibrary "cloudstack_unix";
                   ...
                   {exec_custom = true; exec_main_is = "cloud.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ßn\129\137 @\155ë1ÀK\130>Ñ2\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
